        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card border-light shadow-sm">
                    <div class="card-body">
                        <div class="d-md-flex">
                            <h4 class="card-title mb-3">Crud UI</h4>
                            <div class="ml-auto">
                                <a @click.prevent="create" href="{{route('usermanagement.create')}}"
...
@push("script")
    ...
    <script>
        var app = new Vue({
            ...
            methods: {
                simpan(){
                    axios.post('/api/crud',this.data).then(res=>{
