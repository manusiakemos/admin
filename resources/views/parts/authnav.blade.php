<header class="d-flex align-items-center pl-5 pr-5 pt-3" id="myHeader">
    <div>
        <a href="#" id="sidebarCollapse" class="mr-3 sidebarTogglerButton">
            <img src="{{asset('images/menu.svg')}}" alt="menu" height="20">
        </a>
    </div>
    <div class="ml-auto">
        <ul class="navbar-nav">
            <li class="nav-item dropdown no-arrow show">
                <a class="nav-link" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                    <img width="40" height="40" class="img rounded-circle" src="{{auth()->user()->avatar ? asset('images/'.auth()->user()->avatar) : asset('images/avatar.png')}}">
                </a>
